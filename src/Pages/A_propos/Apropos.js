            ...
            <div id="apropos" className="tabcontent">
                <div id="idcontentapropos">
                    <div id="contenu_apropos">
                        ...
                        <ControlledPopup titre="badminton" image={badminton} texte="Le <span className='keywords'>sport</span> occupe une partie importante de ma semaine, puisque je fais du badminton en club avec ma soeur notamment.
                        ...
                        <ControlledPopup titre="theatre" image={theatre} texte="J'ai fait du <span className='keywords'>théâtre</span> pendant 12 ans quand j'étais plus jeune.
                            Si je n'en fais plus aujourd'hui pour des raisons diverses, je compte bien reprendre à la rentrée prochaine."/>
                        <ControlledPopup titre="craft" image={craft} texte="J'aime <span className='keywords'>bricoler</span> : que ce soit avec mes mains ou mon clavier, je prends beaucoup de plaisir à apporter
                        ...
                        <ControlledPopup titre="cuisine" image={cook} texte="Je <span className='keywords'>cuisine</span> beaucoup aussi.
